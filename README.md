...
v0.2.4 is a packaging fix on top of v0.2.3 (a dependency-version pin conflicting with Home Assistant 2026.8); the architecture is unchanged from the v0.2.0 declarative refactor, built around a declarative core:
...
## SwitchBot requirement in v0.2.4
